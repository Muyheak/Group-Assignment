...
INSERT INTO `eoi` (`EOInumber`, `Job Reference Number`, `First Name`, `Last Name`, `Street Address`, `Suburb/Town`, `State`, `Postcode`, `Email Address`, `Phone Number`, `Windows`, `Linux`, `iOS/MacOS`, `Android`, `Java`, `Python`, `C++`, `JavaScript`, `HTML/CSS`, `SQLskill`, `Other Skills`) VALUES
(3, 'DTS02', 'MuyHeak', 'Long', '30 kathleen st, Preston, VIC, 3072', 'Preston', 'VIC', '3072', '105231643@student.swin.edu.au', '0402157591', 0, 0, 0, 0, 1, 0, 1, 1, 1, 0, '');
